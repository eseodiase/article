    ...
    <main className="main">
      <div className="overlay">
        <article className="component">
          <h2 className="component__heading" aria-hidden="true">
            Component
          </h2>
          ...
          <section className="component__article">
            ...
            <div className="social-icon">
              ...
              <a
                href="#"
                className="social-icon__link social-icon__link--facebook"
              ...
              <a
                href="#"
                className="social-icon__link social-icon__link--twitter"
              ...
              <a
                href="#"
                className="social-icon__link social-icon__link--pinterest"
            ...
            <div className="component__author-info">
              <div className="component__author-identity">
                <img
                  ...
                  alt="Michelle avatar"
                  loading="lazy"
                  className="component__author-img"
                />
              ...
              <button
                ...
                aria-pressed="false"
                className="component__share-button"
                onClick={handleShareClick}
              >
                <span
                  className="component__share-icon"
                  ref={shareIconRef}
                ></span>
              </button>
            </div>
